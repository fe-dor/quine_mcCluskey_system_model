...
public class QuineMcCluskeyAlgorithm {
    ...
    String[] minterms = new String[200];
    String[] dontcares = new String[200];
    String check_list[] = new String[200];


    String[] pass_dontcare = new String[200];
    String[][] track = new String[100][100];
    String[][] track2 = new String[100][100];
    String[][] prime_calc = new String[100][100];
    ...
    String[][] list_track = new String[200][3];
    //to keep track of completed variables
    String[] done = new String[200];
    String[] undone = new String[200];
    //to track the done[]'s index to store completed variables
    int term = 0;
    String[] sub_minterms = new String[200];
    int sub_min_index = 0;
    //index for main array
    int check_list_index;
    //to check if process completed
    char complete_flag = 'F';
    char first_pass_flag = 'T';
    //to check if this is the essential minterms
    int essential_flag = 0;
    char first_prime_flag = 'T';
    char stop_flag='F';
    //temp variable to input the minterms
    String[] passed_minterms = new String[200];
    String[] on_hold_minterms = new String[200];
    int passed_index = 0;
    int on_hold_index = 0;
    ...
    int bits = 0;
    int pass_index = 0;
    String[] first_list = new String[100];
    ...
    public int get_bits(int[] min_array) {
        int max = 0;
        int a = 0;
        int bits = 0;
        while (min_array[a] != -1) {
    ...
    public String[] to_binary(int[] min_array) {
        int a = 0;
    ...
    public String complete_methods() {
        int a = 0, b = 0;
        ...
        return give_output(sub_minterms);
    ...
    public String[][] fill_minterms(String[] input_min) {
        String temp_min;
        int a = 0, count;
    ...
    public String[] fill_dontcare(String[] input_min) {
    ...
    public String[][] compare_adjacent_minterms(String[][] group_wise) {
    ...
    public void prime_fill(String result, String op1, String op2) {
    ...
    public void remove_duplicate_primes() {
    ...
    public String[][] get_essential_primes() {
        int i = 0, j = 0, count = 0;
        int a = 0, b = 0;
        sub_min_index = 0;
    ...
    public String[][] get_primes(String[][] temp_prime_calc) {
    ...
    public String give_output(String[] output_array) {
    ...
    public String[][] fill_dontcares(String[][] filling_array) {
    ...
    public String[][] fill_arrays(String[][] all_combined) {
    ...
    public int[][] fill_int_arrays(int[][] all_combined) {
        for (int i = 0; i < all_combined.length; i++) {
            for (int j = 0; j < all_combined[i].length; j++) {
                all_combined[i][j] = -1;
            }
    ...
    public String[] fill_1d_array(String[] filling_array) {
        for (int i = 0; i < filling_array.length; i++) {
            filling_array[i] = "-1";
        }
        return filling_array;
    ...
    public int[] fill_1d_int_array(int[] temp_array) {
    ...
    public String to_binary_string(int integer_val){
