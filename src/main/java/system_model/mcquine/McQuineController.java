package system_model.mcquine;

import system_model.mcquine.model.Implicant;
import system_model.mcquine.model.McQuineTable;
import system_model.mcquine.model.PrimeImplicant;
...
public class McQuineController {
	private static final String LOG_PATH = "src/test/resources/systemModelLog.txt";
	/**
	 * Number of variables
	 */
...
//					pi.removeMinterm(m);
	...
	public static String calculate(String vect){
		PrintStream fileStream = null;
		try {
			fileStream = new PrintStream(LOG_PATH);
